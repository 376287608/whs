...
<body>
	<div class="layui-main">
		<div id="applyList" class="mt30">
			...
			<div class="layui-col-sm10 layui-col-sm-offset1">
				<ul class="horizontalTree f14 clearfix mb50" id="horizontalTree"></ul>
			</div>
		</div>
	</div>
	<div class="layui-main">
		<div id="applyInfo" class="none mb50">
								...
								<ul id="guidesCon">
									...
									{{#  layui.each(d, function(index, item){ }}
										<li class="layui-elip" data-id="{{item.id}}">
											...
											<a  href="javascipt:;" onclick="openRuleInfo('/guides/getGuidesInfo','办事指南','{{item.id}}')">{{item.guidesName}}</a>
										</li>
									{{#  }); }}
									{{#  if(d.length === 0){ }}
								...
								<ul class="ml5" id="lawsCon">
									...
									{{#  layui.each(d, function(index, item){ }}
										<li class="layui-elip" data-id="{{item.id}}">
											...
											<a href="javascipt:;" onclick="openRuleInfo('/laws/getLawsInfo','法律法规','{{item.id}}')">{{item.lawName}}</a>
										</li>
									{{#}); }}
									{{#  if(d.length === 0){ }}
    									<li class="tc m0"><img src='${ctx}/static/images/noFound.png' style='width:75px'><p class="f14 gray">暂无数据</p></li>
				...
				<div class="layui-col-sm12" id="uploadAttachmentListCon">
					...
					<div class="mt40 mb20 tc">
						<button class="layui-btn layui-btn-normal w100" id="saveBtn" lay-submit
							lay-filter="applyFormSave" id="submitBtn">保存</button>
						<button class="layui-btn w100" lay-submit
	...
	<script src='${ctx}/static/js/company/apply.js'></script>
