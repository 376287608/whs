package com.ufgov.whs.system.interceptor;
...
import com.ufgov.whs.common.mapper.JsonMapper;
...
import com.ufgov.whs.system.utils.IPUtil;
...
public class LogInterceptor implements HandlerInterceptor {
	...
	public void afterCompletion(HttpServletRequest request,
		...
		log.setRemoteAddr(IPUtil.getIpAddress(request));
		log.setOperationCode(operationCode);
		log.setExecuteTime(Integer.valueOf(executeTime.toString()));
		log.setCreateBy(UserUtil.getCurrentUser().getLoginName());
